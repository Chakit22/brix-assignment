    ...
    <div className="card overflow-hidden">
      <div className="overflow-x-auto">
        <div style={{ minWidth: '560px' }}>
          ...
          >
            <div className="px-2 py-3 text-2xs uppercase tracking-widest text-ink-subtle">
              Time
            </div>
            {days.map((day) => {
              ...
              return (
                <div
                  key={day.toISOString()}
                  className={`px-1 py-3 text-center border-l border-border-subtle ${
          ...
          <div>
            {slots.map((slot) => (
              <div
                ...
                style={{ gridTemplateColumns: '56px repeat(7, minmax(72px, 1fr))' }}
              >
                <div className="px-2 py-3 text-2xs font-mono text-ink-subtle border-r border-border-subtle/60">
                ...
                {days.map((day) => {
                  ...
                  return (
                    <div
                      ...
                      className="p-1 border-l border-border-subtle/60"
                    >
                      <CalendarSlot
                        day={day}
